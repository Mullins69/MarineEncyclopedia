<template>
  <div class="container" v-if="mammal">
    <div class="row">
      <div class="col">
    ...
    <div class="row">
      <div class="col">
        <p>
          Dolphins, whales, sea otters and other marine mammals capture the
          imagination and demand the affections of people around the world. Many
          of these marine animals adhere to complex social systems and exhibit
          remarkable intelligence.
        </p>
        <p>
          Learn fun facts and how you can help protect your favorite dolphins,
          whales, sea otter and other marine mammals by clicking a species
          below.
        </p>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-12 col-lg-4" v-for="mammals of mammal" :key="mammals._id">
        <div class="card my-5">
          <img :src="mammals.img" class="card-img-top" alt="..." />
...
export default {
  ...
  mounted() {
    fetch("https://mullins-marine-api.herokuapp.com/mammal", {
      method: "GET",
      headers: {
